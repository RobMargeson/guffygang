...
import divbar from "@/images/div_before.png"
...
<main className="scroll-smooth">
      ...
      <div className="h-48 w-auto bg-black opacity-90 dark:invert" >
      </div>
